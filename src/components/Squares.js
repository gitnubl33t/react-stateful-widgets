...
export default function Squares() {
  ...
  const getClassName = (id) => {
    ...
    return (id = activeSquare ? "active" : reset);
  };
  ...
  const markActive = (id) => {
    ...
    // id != activeSquare ? setActiveSquare(id) : setActiveSquare("");
    activeSquare === id ? setActiveSquare(reset) : setActiveSquare(id);
  };
      ...
      <div className="squares">
        {
          ...
          squares.map((id) => (
            <div
              ...
              key={id}
              className={`square ${
                id === activeSquare ? getClassName(id) : ""
              }`}
